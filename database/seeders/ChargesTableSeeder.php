...
class ChargesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $charges = [
            ...
            [self::SHIPPING_CHARGES, '996511', self::GST_BRACKET, self::BULK_ORDER, '0 to 2000', 'Auto'],
            [self::SHIPPING_CHARGES, '996511', self::GST_BRACKET, self::BULK_ORDER, '2001 to 10000', 'Auto'],
            [self::SHIPPING_CHARGES, '996511', self::GST_BRACKET, self::BULK_ORDER, '>10000', 'Auto'],
            ...
            [self::PACKING_CHARGES, '39231010', self::GST_BRACKET, self::BULK_ORDER, '0 to 2000', 35],
            [self::PACKING_CHARGES, '39231010', self::GST_BRACKET, self::BULK_ORDER, '2001 to 10000', 60],
            [self::PACKING_CHARGES, '39231010', self::GST_BRACKET, self::BULK_ORDER, '>10000', 90],
            ...
            [self::LABOUR_CHARGES, '39231010', self::GST_BRACKET, self::BULK_ORDER, '0 to 2000', 10],
            [self::LABOUR_CHARGES, '39231010', self::GST_BRACKET, self::BULK_ORDER, '2001 to 10000', 20],
            [self::LABOUR_CHARGES, '39231010', self::GST_BRACKET, self::BULK_ORDER, '>10000', 30],
            ...
            [self::PROCESSING_CHARGES, '85192000', self::GST_BRACKET, self::BULK_ORDER, '0 to 2000', '2%'],
            [self::PROCESSING_CHARGES, '85192000', self::GST_BRACKET, self::BULK_ORDER, '2001 to 10000', '2%'],
            [self::PROCESSING_CHARGES, '85192000', self::GST_BRACKET, self::BULK_ORDER, '>10000', '2%'],
