    ...
    public function transform(CompanyPlanPayment $CompanyPlanPayment): array
    {
        ...
        try{
            $data = [
                ...
                'subscription_start_date' => !empty($CompanyPlanPayment->companyPlans) ? $CompanyPlanPayment->companyPlans->subscription_start_date->format('d-m-Y') : '',  
                'subscription_end_date' => !empty($CompanyPlanPayment->companyPlans) ? $CompanyPlanPayment->companyPlans->subscription_end_date->format('d-m-Y'): '',
