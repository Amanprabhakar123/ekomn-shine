...
<div class="ek_dashboard">
    <div class="ek_content">
        <div class="card ekcard pa shadow-sm">
            <div class="cardhead">
                <h3 class="cardtitle">Edit Sub Admin Account </h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="ek_group">
                            ...
                            <div class="ek_f_input">
                                <input type="hidden" id="userId" name="name" value="{{salt_encrypt($users->id)}}" class="form-control userico" placeholder="name" />
                                <input type="text" id="name" name="name" value="{{$users->name}}" class="form-control userico" placeholder="name" />
                    ...
                    <div class="col-md-6">
                        <div class="ek_group">
                            ...
                            <div class="ek_f_input">
                                <input type="text" id="email" name="email" value="{{$users->email}}" class="form-control userico" placeholder="Email Address" disabled/>
                    ...
                    <div class="col-md-6">
                        <div class="ek_group">
                            ...
                            <div class="ek_f_input">
                                <input type="password" id="password" value="" name="password" class="form-control pwdico" placeholder="Password" />
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                ...
                                <input type="checkbox" id="checkbox-{{$loop->index}}" name="{{ $key }}" checked class="form-check-input" />
                                @else
...
<script>
    $('#subAdmin').on('submit', function(e) {
        ...
        if(isValid) {
            ApiRequest('update-admin-list',  'POST', formData)
                .then(response => {
