        ...
        <div class="card ekcard pa shadow-sm">
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="orderStatus_d">
                    <div><strong class="me-2">Full Name:</strong><span class="opacity-75">Mohd Imtyaj</span></div>
                    <div><strong class="me-2">Email Address:</strong><span class="opacity-75">imtyaj92@outlook.com</span></div>
                    <div><strong class="me-2">Phone No:</strong><span class="opacity-75">+91 7827821676</span></div>
                </div>
                </section>
                <section class="mt5">
                <div class="row">
