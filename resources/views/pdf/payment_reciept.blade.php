        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
          ...
          <tr>
            <td style="width: 50%; vertical-align: top;">
              <h3 style="font-size: 14px; color: #131A22; font-family: 'Open Sans', sans-serif;margin: 0px 0px 2px 0px">Company Name</h3>
              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0; line-height: 18px;">
                {{$ekomn_details->ekomn_name}} <br>
                {{$ekomn_details->address}} {{$ekomn_details->pincode}} 
                {{$ekomn_details->city}}
                <br>
              </p>
            </td>
            ...
            <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif; margin: 0; text-align: right;">
                <strong style="vertical-align: middle;">Payment Date:</strong>
                <span style="display: inline-block; width: 120px; vertical-align: middle;margin-top:4px;">{{$payment_date}}</span>
            </p>

              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0px 0px 4px 0px; text-align: right;">
                <strong style="vertical-align: middle;">Receipt No:</strong><span style="display: inline-block;width:120px;font-size: 12px; vertical-align: middle;margin-top:4px;">{{ $invoice_number }}</span>
              </p>
              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0px 0px 4px 0px; text-align: right;">
          ...
          <tr>
            <td style="width: 50%; vertical-align: top;">
              <h3 style="font-size: 14px; color: #131A22; font-family: 'Open Sans', sans-serif;margin: 0px 0px 2px 0px">Received From</h3>
              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0; line-height: 18px;">
                {{$supplier_name}}<br>
                {{$supplier_address}}<br>
                {{$supplier_city}}<br>
            ...
            <td style="width: 50%; vertical-align: top;text-align: right;">
              <h3 style="font-size: 14px; color: #131A22; font-family: 'Open Sans', sans-serif;margin: 0px 0px 2px 0px">State Bank Of India</h3>
              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0px 0px 4px 0px; text-align: right;">
                <strong style="vertical-align: middle;">IFSC Code:</strong><span style="display: inline-block;width:120px;font-size: 12px; vertical-align: middle;margin-top:4px;">{{$ifsc_code}}</span>
              </p>
              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0px 0px 4px 0px; text-align: right;">
                <strong  style="vertical-align: middle;">Account No:</strong><span style="display: inline-block;width:120px;font-size: 12px; vertical-align: middle;margin-top:4px;">{{$account_number}}</span>
              </p>
              <p style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;margin: 0px 0px 4px 0px; text-align: right;">
                <strong  style="vertical-align: middle;">Payment Method:</strong><span style="display: inline-block;width:120px;font-size: 12px; vertical-align: middle;margin-top:4px;">Bank Transfer/NEFT{{$payment_method}}</span>
              </p>
            </td>
          </tr>
        </table>
      ...
      <td style="padding: 20px 0px;">
        ...
        @endphp
          @foreach($order_items as $orderItem)
            ...
            $shippin_gst = $orderItem->	shipping_gst_percent;
            ...
            <tr>
              ...
              <td style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;padding: 6px 8px;line-height: 16px;border-bottom: 1px solid #ddd;text-align: right;"></td>
              <td style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;padding: 6px 8px;line-height: 16px;border-bottom: 1px solid #ddd;text-align: right;"></td>
              <td style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;padding: 6px 8px;line-height: 16px;border-bottom: 1px solid #ddd;text-align: right;"><img src="{{$rupee}}" width="7" height="10">{{number_format(($total_gst_amount+$produc_gst+(($shipping_charges- ($shipping_charges/(1+($shippin_gst/100)))))), 2)}}</td>
            ...
            <tr>
              <td colspan="8" style="font-size: 13px; color: #424242; font-family: 'Open Sans', sans-serif;padding: 0px 2px 6px 2px;line-height: 18px;text-align: left; font-weight:bold;text-align:right;">
                <img src="{{$paid}}" width="90" height="90" style="margin-top:-25px;"><br>
                Payment status
              </td>
            </tr>
          </tbody>
