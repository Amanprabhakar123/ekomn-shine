        ...
        <div class="login-container">
            ...
            @enderror
                    ...
                    <div class="text-end mt-1">
                        <a href="{{ route('supplier.forget') }}" class="a_color text_u">Forgot Password?</a>
                    </div>
                    ...
                    <a href="{{ route('supplier.register') }}" class="btn btn-login btnekomn-border block">Register Now</a>
                </div>
            </form>
