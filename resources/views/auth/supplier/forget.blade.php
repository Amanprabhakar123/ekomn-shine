      ...
      @include('auth.layout.sidebar_slider')
        <div class="login-container">
          ...
          @include('auth.layout.logo')
            ...
            <a href="reset-password.html" class="btn btn-login btnekomn block my-4">Request reset link</a>
            <div class="d-flex justify-content-center">
              <a href="user-login.html" class="btn btn-link a_color">Back To Login</a>
            </div>
          </div>
