      ...
      <div class="topSection_w_cat">
        <div class="productFilters">
          <div class="filterCards ekom_card" id="productFilters">
            <div class="categoryListAll fscborder">
              <h4 class="m-0 fs-18 bold">Home, Garden & Tools</h4>
              <div class="mt15">
                <h6 class="bold m-0">Decor</h6>
                <ul>
                  <li><a href="">Home Decor</a></li>
                  <li><a href="">Wall Art</a></li>
                  <li><a href="">Seasonal Decor</a></li>
                </ul>
              </div>
              <div class="mt15">
                <h6 class="bold m-0">Furniture</h6>
                <ul>
                  <li><a href="">Bedroom Furniture</a></li>
                  <li><a href="">Living Room Furniture</a></li>
                  <li><a href="">Kitchen & Dining Room Furniture</a></li>
        ...
        <div class="productListing">
          <div class="sub_banner">
            <img src="../assets/images/web/home_dec.jpg">
          </div>
          <div class="pt-1">
