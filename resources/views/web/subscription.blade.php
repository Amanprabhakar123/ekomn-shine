          ...
          <div class="pricing-container pt-0 mt-5">
            ...
            <div class="features-list">
              <div class="tooltips">
                <div class="feature-row">
                  ...
                  <div class="feature-value">{{$plans[0]['inventory_count']}}</div>
              ...
              <span class="tooltiptext">Allowed limit of product content download that you are allowed to do in a month</span>
                <div class="feature-row">
                  ...
                  <div class="feature-value">{{$plans[0]['download_count']}}</div>
            ...
            <div class="tooltips">
              ...
              <div class="feature-row">
                ...
                <div class="feature-value"><i class="{{$plans[0]['price_and_stock'] ? 'fas fa-check text-success' : 'fas fa-times text-danger'}}"></i></div>
              ...
              <div class="feature-row">
                ...
                <div class="feature-value"><i class="{{$plans[0]['reseller_program'] ? 'fas fa-check text-success' : 'fas fa-times text-danger'}}"></i></div>
              ...
              <div class="feature-row">
                ...
                <div class="feature-value"><i class="{{$plans[0]['shine_program'] ? 'fas fa-check text-success' : 'fas fa-times text-danger'}}"></i></div>
